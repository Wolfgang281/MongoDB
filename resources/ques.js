...
! Find departments where headOfDept exists (non-null). 
db.dept.find({headOfDept:{$ne:null}}, {headOfDept:1})

! Query employees whose age is between 25 and 40 (inclusive). 
*/
...
// 3. Find all employees who have more than 4 skills
db.emp.find(
  {
    $expr: {
      $gt: [{ $size: "$skills" }, 4],
...
// ============================================
// EVALUATION OPERATORS ($regex, $expr, $mod, $where(X))
// ============================================
